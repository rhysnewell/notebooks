...
#~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~#
# All samples at once
filt_gene_cov <- fread("/srv/projects/abisko/rhys/01-projects/02-anme/03-genomes/dirseq_out/filtrate_gene_cov.tsv")
retn_gene_cov <- fread("/srv/projects/abisko/rhys/01-projects/02-anme/03-genomes/dirseq_out/retentate_gene_cov.tsv")
...
filt_gene_cov_1 <- fread("/srv/projects/abisko/rhys/01-projects/02-anme/03-genomes/dirseq_out/filtrate_anme_removed_chimeras.fna.SB8774_S41_R1_001.fastq.gz_gene_cov.tsv")[, mean_cov:=(forward_average_coverage+reverse_average_coverage)/2]
filt_gene_cov_2 <- fread("/srv/projects/abisko/rhys/01-projects/02-anme/03-genomes/dirseq_out/filtrate_anme_removed_chimeras.fna.SC5420_S10_R1_001.fastq.gz_gene_cov.tsv")[, mean_cov:=(forward_average_coverage+reverse_average_coverage)/2]
filt_gene_cov_3 <- fread("/srv/projects/abisko/rhys/01-projects/02-anme/03-genomes/dirseq_out/filtrate_anme_removed_chimeras.fna.SC5422_S12_R1_001.fastq.gz_gene_cov.tsv")[, mean_cov:=(forward_average_coverage+reverse_average_coverage)/2]
...
retn_gene_cov_1 <- fread("/srv/projects/abisko/rhys/01-projects/02-anme/03-genomes/dirseq_out/retentate_anme_nanopore_redo.fna.SB8775_S42_R1_001.fastq.gz_gene_cov.tsv")[, mean_cov:=(forward_average_coverage+reverse_average_coverage)/2]
retn_gene_cov_2 <- fread("/srv/projects/abisko/rhys/01-projects/02-anme/03-genomes/dirseq_out/retentate_anme_nanopore_redo.fna.SC5421_S11_R1_001.fastq.gz_gene_cov.tsv")[, mean_cov:=(forward_average_coverage+reverse_average_coverage)/2]
retn_gene_cov_3 <- fread("/srv/projects/abisko/rhys/01-projects/02-anme/03-genomes/dirseq_out/retentate_anme_nanopore_redo.fna.SC5423_S13_R1_001.fastq.gz_gene_cov.tsv")[, mean_cov:=(forward_average_coverage+reverse_average_coverage)/2]
retn_gene_cov_4 <- fread("/srv/projects/abisko/rhys/01-projects/02-anme/03-genomes/dirseq_out/retentate_anme_nanopore_redo.fna.SC5423_S48_R1_001.fastq.gz_gene_cov.tsv")[, mean_cov:=(forward_average_coverage+reverse_average_coverage)/2]
